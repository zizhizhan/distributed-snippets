...
COPY language (language_id, name, last_update) FROM '$$PATH$$/language.dat';

--
-- Data for Name: category; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('category_category_id_seq', 16, true);
COPY category (category_id, name, last_update) FROM '$$PATH$$/category.dat';

--
-- Data for Name: country; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('country_country_id_seq', 109, true);
COPY country (country_id, country, last_update) FROM '$$PATH$$/country.dat';
--
-- Data for Name: city; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('city_city_id_seq', 600, true);
COPY city (city_id, city, country_id, last_update) FROM '$$PATH$$/city.dat';

--
-- Data for Name: address; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('address_address_id_seq', 605, true);
COPY address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '$$PATH$$/address.dat';

--
-- Data for Name: actor; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('actor_actor_id_seq', 200, true);
COPY actor (actor_id, first_name, last_name, last_update) FROM '$$PATH$$/actor.dat';


--
-- Data for Name: store; Type: TABLE DATA; Schema: public; Owner: postgres
--
COPY store (store_id, manager_staff_id, address_id, last_update) FROM '$$PATH$$/store.dat';

--
-- Data for Name: staff; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('staff_staff_id_seq', 2, true);
COPY staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '$$PATH$$/staff.dat';

--
-- Data for Name: customer; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('customer_customer_id_seq', 599, true);
COPY customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '$$PATH$$/customer.dat';

--
-- Data for Name: film; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('film_film_id_seq', 1000, true);
COPY film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '$$PATH$$/film.dat';

--
-- Data for Name: film_category; Type: TABLE DATA; Schema: public; Owner: postgres
--
COPY film_category (film_id, category_id, last_update) FROM '$$PATH$$/film_category.dat';

--
-- Data for Name: film_actor; Type: TABLE DATA; Schema: public; Owner: postgres
--
COPY film_actor (actor_id, film_id, last_update) FROM '$$PATH$$/film_actor.dat';

--
-- Data for Name: inventory; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('inventory_inventory_id_seq', 4581, true);
COPY inventory (inventory_id, film_id, store_id, last_update) FROM '$$PATH$$/inventory.dat';

--
-- Data for Name: rental; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('rental_rental_id_seq', 16049, true);
COPY rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '$$PATH$$/rental.dat';

--
-- Data for Name: payment; Type: TABLE DATA; Schema: public; Owner: postgres
--
SELECT pg_catalog.setval('payment_payment_id_seq', 32098, true);
COPY payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/payment.dat';
